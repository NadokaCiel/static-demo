...
docker run -d --name jenkins --restart=unless-stopped -p 8083:8080 -p 50000:50000 -u 1000:1000 -v /vol1/1000/dev/docker/shared:/var/jenkins_home/workspace/shared -v /vol1/1000/dev/docker/jenkins:/var/jenkins_home -v /var/run/docker.sock:/var/run/docker.sock -v $(which docker):/usr/bin/docker:ro  jenkins/jenkins:latest